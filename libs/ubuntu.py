...
def ubuntu_menu():
    ...
    [08] - Firefox
        """)
            cmd = str(input('===> '))
            if cmd == '1':
                system('sudo apt update ; sudo apt install snapd ; sudo snap install brave --classic')
            elif cmd == '2':
                ...
                system('sudo apt update ; sudo apt install snapd ; sudo snap install chromium')
            elif cmd == '4':
                ...
                system('sudo apt update ; sudo apt install snapd ; sudo snap install discord')
            elif cmd == '6':
                system('sudo apt update ; sudo apt install snapd ; sudo snap install skype')
            elif cmd == '7':
                system('sudo apt update ; sudo apt install snapd ; sudo snap install telegram-desktop')
            elif cmd == '8':
                system('sudo apt update ; sudo apt install snapd ; sudo snap install firefox')
    ...
    [07] - Audacity
        """)
            ...
            if cmd == '1':
                ...
                system('sudo apt update ; sudo apt install snapd ; sudo snap install vlc')
            elif cmd == '3':
                system('sudo add-apt-repository ppa:ubuntu-audio-dev/Pulse-testing ; sudo apt-get update ; sudo apt-get install pulseaudio')
            elif cmd == '4':
                system('sudo apt update ; sudo apt install snapd ; sudo snap install simplescreenrecorder')
            elif cmd == '5':
                system('sudo apt update ; sudo apt install snapd ; sudo snap install obs-studio')
            elif cmd == '6':
                system('sudo apt update ; sudo apt install snapd ; sudo snap install gimp')
            elif cmd == '7':
                system('sudo apt update ; sudo apt install snapd ; sudo snap install vidcutter')
            elif cmd == '8':
                system('sudo apt update ; sudo apt install snapd ; sudo snap install audacity')
